...
export const NAVBAR_MENU_CLASSNAME = 'from-teal-400 to-emerald-600 bg-gradient-to-r';

export const NAVBAR_MENU_LINK_CLASSNAME =
  'hover:font-semibold bg-emerald-700/[.3] hover:bg-emerald-700 lowercase text-white rounded-2xl p-4';
