...
const MEDIA_BASE_PATH = 'posts/2022-01-09';
...
export const POST: IPost = {
  ...
  components: [
    new Photo({
      src: resolveImagePath(`${MEDIA_BASE_PATH}/1.png`),
      description: 'Pixlr homepage',
    }),
    ...
    new Photo({
      ...
      src: resolveImagePath(`${MEDIA_BASE_PATH}/2.png`),
    }),

    new Photo({
      description: 'Pixlr X',
      showDescription: true,
      src: resolveImagePath(`${MEDIA_BASE_PATH}/3.png`),
    }),
