...
export function Footer() {
  ...
  return (
    <div className='grid items-end flex-grow grid-cols-2 pb-2 sm:pb-0'>
      <div className='ml-1'>
        <blockquote className='max-w-[460px] p-4 border-s-4 border-orange-500 bg-orange-600/[.25] rounded-r-2xl'>
          <p className='italic text-white text-md'>I have not failed. I just found 10,000 ways that won't work.</p>
